...
let iddReqs = document.getElementById("idd-reqs");

for (let iddCourse of iddCourses) 
{
    console.log(iddCourse);
    iddReqs.innerHTML += 
        `<div class="card my-2">
        <div class="card-body">
          <div class="row">
            <h5 class="card-title col">
              <b>${iddCourse["Course Name"]}</b>
            </h5>
            <p class="col-3 text-end">${iddCourse["Credit Hours"]} hours</p>
          </div>

          <div class="row">
            <div class="col">
              <p class="card-subtitle"> ${iddCourse["Course ID"]}</p>
            </div>
            <div class="col-4 text-end">
              <span class="text-muted">${iddCourse["Semester Offered"]}</span>
            </div>
          </div>
          <a
            href="#${convertID(iddCourse["Course ID"])}"
            class="card-link fw-light"
            data-bs-toggle="collapse"
            role="button"
            aria-expanded="false"
          ...
          <div
            class="course-description collapse card-text"
            id="${convertID(iddCourse["Course ID"])}"
          >
            <p class="text-muted card-text">
            ${iddCourse["Course Description"]}
            </p>
